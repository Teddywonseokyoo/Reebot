...
//        try {
//            Iterator iterator = tvsignal.getJSONObject("SIGNAL").keys();
//            while (iterator.hasNext())
//            {
//                Log.d(TAG,"tvsignal : " + iterator.next().toString());
//            }
...
//
//        try {
//            Iterator iterator = stboxsignal.getJSONObject("SIGNAL").keys();
//            while (iterator.hasNext())
//            {
//                Log.d(TAG,"stboxsignal : " + iterator.next().toString());
//            }
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
