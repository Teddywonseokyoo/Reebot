...
public class BookingActivity extends AppCompatActivity implements EventCallback, OnEPGListClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            Log.d(TAG, "onCreate acesstoken: " + acesstoken);
            ...
            reeBotApi.reqBookingList(email, acesstoken);
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case DialogInterface.BUTTON_POSITIVE:
                        reeBotApi.reqBookingRemove(epgListViewItem.getBookingId(), acesstoken);
