...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, OnEPGListClickListener, OnEPGItemClickListener, View.OnClickListener {
...
//    private int prevSelectFragmentPostition = 0;
    ...
    private Boolean exitprogrma = false;
...
//                ((TextView) headerView.findViewById(R.id.txt_email)).setText(email);
            ...
            if (bundle.getString("accesstoken") != null) {
                Log.d(TAG, "accesstoken : " + bundle.getString("accesstoken"));
...
//                ProgramListVerticalDialog programListDialog = new ProgramListVerticalDialog(MainActivity.this, epgListViewItem, this);
//                programListDialog.show();
    ...
    private OnEPGListCallback onEPGListCallback = new OnEPGListCallback() {
        ...
        public void requestSearchEPGList(ArrayList<EPGListViewItem> epgListViewItemList) {
            ProgramListVerticalDialog programListDialog = new ProgramListVerticalDialog(MainActivity.this, epgListViewItemList, MainActivity.this);
            programListDialog.show();
        }
        ...
        public void requestEPGProgramList(ArrayList<EPGItem> epgItemList) {
            ...
            ProgramListVerticalDialog programListDialog = new ProgramListVerticalDialog(MainActivity.this, channelEpgListViewItem, MainActivity.this);
            programListDialog.show();
        }
    };

    private BookingCallback bookingCallback = new BookingCallback() {
        @Override
    ...
    private void searchProgram(String text) {
        reeBotApi.reqSearchEpgList(getCatvRemoveNumber(), text, onEPGListCallback);
...
//                signal.execute(new RBIRParamData(2, getsignalurl, separated[0], "room1", "signalsbox", catv, ""));
                ...
                reeBotApi.reqIRSignal(new RBIRParamData("", separated[0], "room1", "signalsbox", catv, ""), signalCallback);
...
//                signal.execute(new RBIRParamData(2, getsignalurl, separated[0], "room1", "signaltv", tv, ""));
                ...
                reeBotApi.reqIRSignal(new RBIRParamData("", separated[0], "room1", "signaltv", tvb, ""), signalCallback);
//                reeBotApi.reqSignalList(new RBIRParamData(ExtraInfo.REQ_MODE_REMOTE_IR_SIGNAL_TV, "", separated[0], "room1", "signaltv", tvb, ""));
    ...
    private void getChannelEpg(EPGListViewItem epgListViewItem) {
        ...
        reeBotApi.reqEpgProgramList(getCatvRemoveNumber(), epgListViewItem.getList().get(0).getChnumber(), onEPGListCallback);
    }
...
//            bookingProgram(epgListViewItem);
            ...
            reeBotApi.reqBookingAdd(epgItem, getEmail(), getCatvRemoveNumber(), pushToken, getAccesstoken(), bookingCallback);
